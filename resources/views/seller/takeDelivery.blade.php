              ...
              @endif
                ...
                <a class="btn btn-primary" href="{{URL::to("/seller/takeOrDelivery")}}" role="button">Take/Delivery status</a>
                  ...
                  <table class="table" style="width: 100%; color:black;">
                    ...
                    <td style="border: 1px solid #ddd;">{{$o->delivery_method}}</td>
                    <td style="border: 1px solid #ddd;">{{$o->total_price}}</td>
                    <td style="border: 1px solid #ddd;">{{$o->address}}</td>
                    <td style="border: 1px solid #ddd;">{{$o->status}}</td>
                    </tr>
